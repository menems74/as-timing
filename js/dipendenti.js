...
import { getDipendenti, addDipendente, updateDipendente, deleteDipendente } from "./data.js?v=28";
import { creaAccessoDipendente, inviaResetPassword } from "./admin-auth.js?v=28";
